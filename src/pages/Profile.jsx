        ...
        <div className="w-full md:w-1/3 lg:w-1/4">
          <div className="luxury-card p-6 text-center">
            <div className="relative inline-block mb-4">
              <img
                src={user?.profilePic && user?.profilePic !== 'https://res.cloudinary.com/rtfmu2pg/image/upload/v1784374987/default_hqb1tc.webp' ? user?.profilePic : 'https://res.cloudinary.com/rtfmu2pg/image/upload/v1784374987/default_hqb1tc.webp'}
                alt="Profile"
